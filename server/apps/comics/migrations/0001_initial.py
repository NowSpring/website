...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('version', models.PositiveIntegerField(validators=[django.core.validators.MinValueValidator(0)], verbose_name='巻数')),
                ('cover', models.ImageField(blank=True, upload_to='cover/version/')),
                ('title', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='comics.comicmaster', verbose_name='タイトル')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('episode', models.PositiveIntegerField(validators=[django.core.validators.MinValueValidator(0)], verbose_name='エピソード数')),
                ...
                ('include', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='comics.comicversion', verbose_name='収録作品')),
            ],
            options={
